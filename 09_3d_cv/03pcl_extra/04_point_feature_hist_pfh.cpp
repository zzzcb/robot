...
//
/*
 * 基于特征不变性的点云配准 fpfh :fast point feature hist
 * http://robot.czxy.com/docs/pcl/chapter03/registration/#_9
 */
...
int main(int argc, char **argv) {
    ...
    // Point clouds
    PointCloudT::Ptr object(new PointCloudT); // chef.pcd 厨师
    PointCloudT::Ptr object_aligned(new PointCloudT);
    PointCloudT::Ptr scene(new PointCloudT); // rs1.pcd 场景(两个恐龙,一个厨师)
    ...
    // Estimate normals for scene 给场景计算法向量
    ...
    fest.setRadiusSearch(0.025); // 要比 0.01 大
