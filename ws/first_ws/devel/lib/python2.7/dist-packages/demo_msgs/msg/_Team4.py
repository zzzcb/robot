...
"""autogenerated by genpy from demo_msgs/Team4.msg. Do not edit."""
import codecs
import sys
...
class Team4(genpy.Message):
  _md5sum = "ccc100d1d4c1606945bd893da4b64a28"
  _type = "demo_msgs/Team4"
...
float64 y
float64 z"""
  __slots__ = ['name','leader','intro','location','members']
  _slot_types = ['string','demo_msgs/Student','std_msgs/String','geometry_msgs/Twist','demo_msgs/Student[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,leader,intro,location,members
    ...
    """
    if args or kwds:
      super(Team4, self).__init__(*args, **kwds)
