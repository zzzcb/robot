...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_egm_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::abb::egm::EgmTestSignals, signals1_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 163, 177, sizeof(::abb::egm::EgmRobot)},
  { 186, 194, sizeof(::abb::egm::EgmSensor)},
  { 197, 204, sizeof(::abb::egm::EgmSensorPathCorr)},
};
...
const char descriptor_table_protodef_egm_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "NG\020\002\"\"\n\016EgmTestSignals\022\020\n\010signals1\030\001 \003(\001"
  "\"!\n\020EgmMeasuredForce\022\r\n\005force\030\001 \003(\001\"\203\003\n\010"
  "EgmRobot\022\"\n\006header\030\001 \001(\0132\022.abb.egm.EgmHe"
  "ader\022&\n\010feedBack\030\002 \001(\0132\024.abb.egm.EgmFeed"
  "Back\022$\n\007planned\030\003 \001(\0132\023.abb.egm.EgmPlann"
  "ed\022*\n\nmotorState\030\004 \001(\0132\026.abb.egm.EgmMoto"
  "rState\022&\n\010mciState\030\005 \001(\0132\024.abb.egm.EgmMC"
  "IState\022\031\n\021mciConvergenceMet\030\006 \001(\010\022,\n\013tes"
  "tSignals\030\007 \001(\0132\027.abb.egm.EgmTestSignals\022"
  "6\n\016rapidExecState\030\010 \001(\0132\036.abb.egm.EgmRap"
  "idCtrlExecState\0220\n\rmeasuredForce\030\t \001(\0132\031"
  ".abb.egm.EgmMeasuredForce\"}\n\tEgmSensor\022\""
  "\n\006header\030\001 \001(\0132\022.abb.egm.EgmHeader\022$\n\007pl"
  "anned\030\002 \001(\0132\023.abb.egm.EgmPlanned\022&\n\010spee"
  "dRef\030\003 \001(\0132\024.abb.egm.EgmSpeedRef\"_\n\021EgmS"
  "ensorPathCorr\022\"\n\006header\030\001 \001(\0132\022.abb.egm."
  "EgmHeader\022&\n\010pathCorr\030\002 \001(\0132\024.abb.egm.Eg"
  "mPathCorr"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_egm_2eproto = {
  false, false, 2409, descriptor_table_protodef_egm_2eproto, "egm.proto", 
...
descriptor_table_egm_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_egm_2eproto);
  return descriptor_table_egm_2eproto.file_level_metadata[index];
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 9)) {
          ...
          do {
            ptr += 1;
            _internal_add_signals1(::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr));
            ptr += sizeof(double);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<9>(ptr));
        } else if (static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedDoubleParser(_internal_mutable_signals1(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* EgmTestSignals::_InternalSerialize(
  ...
  // repeated double signals1 = 1;
  for (int i = 0, n = this->_internal_signals1_size(); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(1, this->_internal_signals1(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:abb.egm.EgmTestSignals)
  ...
  // repeated double signals1 = 1;
  {
    unsigned int count = static_cast<unsigned int>(this->_internal_signals1_size());
    size_t data_size = 8UL * count;
    total_size += 1 *
                  ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(this->_internal_signals1_size());
    total_size += data_size;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:abb.egm.EgmTestSignals)
  ...
  signals1_.MergeFrom(from.signals1_);
}
...
void EgmTestSignals::InternalSwap(EgmTestSignals* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  signals1_.InternalSwap(&other->signals1_);
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:abb.egm.EgmRobot)
  ...
  if (cached_has_bits & 0x00000100u) {
    _internal_set_mciconvergencemet(from._internal_mciconvergencemet());
  }
}
