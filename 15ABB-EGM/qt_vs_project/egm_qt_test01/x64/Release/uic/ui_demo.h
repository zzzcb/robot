...
public:
    ...
    void setupUi(QMainWindow *DemoClass)
    {
        ...
        drawBoard = new MyDrawBoard(groupBox_2);
        drawBoard->setObjectName(QString::fromUtf8("drawBoard"));
        drawBoard->setMinimumSize(QSize(400, 400));
        drawBoard->setMaximumSize(QSize(400, 400));
        drawBoard->setFrameShape(QFrame::StyledPanel);
        drawBoard->setFrameShadow(QFrame::Raised);

        gridLayout_3->addWidget(drawBoard, 0, 0, 1, 2);
