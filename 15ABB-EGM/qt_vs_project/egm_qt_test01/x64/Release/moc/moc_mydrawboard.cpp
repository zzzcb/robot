/****************************************************************************
** Meta object code from reading C++ file 'mydrawboard.h'
**
...
#error "The header file 'mydrawboard.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 12), // "currentPoint"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 2) // "pt"

    },
    "MyDrawBoard\0currentPoint\0\0pt"
};
...
void MyDrawBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentPoint((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyDrawBoard::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyDrawBoard::currentPoint)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyDrawBoard::currentPoint(QPoint _t1)
{
