...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_egm_2eproto_metadata_getter(int index);
namespace abb {
namespace egm {
class EgmCartesian;
...
class EgmHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_egm_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class EgmTestSignals PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kSignals1FieldNumber = 1,
  };
  // repeated double signals1 = 1;
  int signals1_size() const;
  private:
  int _internal_signals1_size() const;
  public:
  void clear_signals1();
  private:
  double _internal_signals1(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
      _internal_signals1() const;
  void _internal_add_signals1(double value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
      _internal_mutable_signals1();
  public:
  double signals1(int index) const;
  void set_signals1(int index, double value);
  void add_signals1(double value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
      signals1() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
      mutable_signals1();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< double > signals1_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_egm_2eproto;
};
// -------------------------------------------------------------------
...
// repeated double signals1 = 1;
inline int EgmTestSignals::_internal_signals1_size() const {
  return signals1_.size();
}
inline int EgmTestSignals::signals1_size() const {
  return _internal_signals1_size();
}
inline void EgmTestSignals::clear_signals1() {
  signals1_.Clear();
}
inline double EgmTestSignals::_internal_signals1(int index) const {
  return signals1_.Get(index);
}
inline double EgmTestSignals::signals1(int index) const {
  // @@protoc_insertion_point(field_get:abb.egm.EgmTestSignals.signals1)
  return _internal_signals1(index);
}
inline void EgmTestSignals::set_signals1(int index, double value) {
  signals1_.Set(index, value);
  // @@protoc_insertion_point(field_set:abb.egm.EgmTestSignals.signals1)
}
inline void EgmTestSignals::_internal_add_signals1(double value) {
  signals1_.Add(value);
}
inline void EgmTestSignals::add_signals1(double value) {
  _internal_add_signals1(value);
  // @@protoc_insertion_point(field_add:abb.egm.EgmTestSignals.signals1)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
EgmTestSignals::_internal_signals1() const {
  return signals1_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
EgmTestSignals::signals1() const {
  // @@protoc_insertion_point(field_list:abb.egm.EgmTestSignals.signals1)
  return _internal_signals1();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
EgmTestSignals::_internal_mutable_signals1() {
  return &signals1_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
EgmTestSignals::mutable_signals1() {
  // @@protoc_insertion_point(field_mutable_list:abb.egm.EgmTestSignals.signals1)
  return _internal_mutable_signals1();
}
